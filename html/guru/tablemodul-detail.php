            ...
            <div class="row">
              <div class="card" style="padding:20px">
                <div class="row">
                  ...
                  <?php
                  $dataModul = tampildata("SELECT * from tbl_moduls where id=$id and id_guru=$user_id");
                        ...
                        <div class="modal fade" id="delete<?= $row['id'] ?>" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <form method="POST" action="../../controller/guru/deletecontent.php"> <!-- Ensure the action points to the PHP file handling the delete -->
