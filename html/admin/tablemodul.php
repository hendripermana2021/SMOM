                            ...
                            <div class="modal-content">
                              ...
                              <form method="POST" action="" enctype="multipart/form-data"> <!-- Ensure the action points to the PHP file handling the update -->
                                ...
                                <div class="modal-body">
                                  ...
                                  <?php if ($row['type_modul'] == 1): ?>
                                    <div class="row mb-3">
                                      <label class="col-sm-2 col-form-label">Update PDF</label>
                                      <div class="col-sm-10">
                                        <div class="input-group">
                                          <label class="input-group-text" for="uploadPdf"><i class="bx bx-file"></i></label>
                                          <input type="file" class="form-control" id="uploadPdf" name="uploadPdf" value="<?= $row['filePdf'] ?>" accept="application/pdf">
                                        </div>
                                      </div>
                                    </div>
                                  <?php endif; ?>
                                  ...
                                  <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                      <div class="input-group">
                                        <label class="input-group-text" for="inputGroupFile01"><i class="bx bx-image-add"></i></label>
                                        <input type="file" class="form-control" name="image" value="<?= $row['image'] ?>" accept="image/*" id="inputGroupFile01" />
                                      </div>
                                    </div>
                                  </div>
                                </div>
